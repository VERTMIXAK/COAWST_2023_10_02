...
names3 = {'Qair','Pair',  'rain', 'lwrad_down', 'swrad', 'cloud', 'albedo'};
times3 = {'qrel_time','pair_time', 'rain_time', 'lrf_time', 'srf_time', 'cloud_time', 'albedo_time'};

names4 = { 'Qair', 'Tair', 'Uwind', 'Vwind'};
times4 = { 'qair_time', 'tair_time', 'wind_time', 'wind_time'};

long3  = {'Relative Humidity at 2m','Pressure at 2m','rain at surface','downward longwave radiation at surface','downward shortwave radiation at surface','total cloud cover','albedo at ground'};
